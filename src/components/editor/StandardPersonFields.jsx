    ...
    <div className={styles.standardPersonWrap}>
      ...
      <Form fluid>
        ...
        <MultiRelationshipField
          label="Children"
          field="children"
          hidden={fieldHidden(person, 'children')}
          onToggleHidden={(checked) => updateHiddenField('relationships', 'children', checked)}
          options={childrenOptions}
          valueArr={childrenArr}
          onChange={(val) => setRelMulti('children', val)}
          onSearch={setChildrenSearch}
          onPhotoChange={(name, val) => setRelMultiPhoto('children', name, val)}
        />
        <MultiRelationshipField
          label="Siblings"
          field="siblings"
          hidden={fieldHidden(person, 'siblings')}
          onToggleHidden={(checked) => updateHiddenField('relationships', 'siblings', checked)}
          options={siblingsOptions}
          valueArr={siblingsArr}
          onChange={(val) => setRelMulti('siblings', val)}
          onSearch={setSiblingsSearch}
          onPhotoChange={(name, val) => setRelMultiPhoto('siblings', name, val)}
        />
        <MultiRelationshipField
          label="Girlfriends"
          field="girlfriends"
          hidden={fieldHidden(person, 'girlfriends')}
          onToggleHidden={(checked) => updateHiddenField('relationships', 'girlfriends', checked)}
          options={girlfriendsOptions}
          valueArr={girlfriendsArr}
          onChange={(val) => setRelMulti('girlfriends', val)}
          onSearch={setGirlfriendsSearch}
          onPhotoChange={(name, val) => setRelMultiPhoto('girlfriends', name, val)}
        />
        <MultiRelationshipField
          label="Boyfriends"
          field="boyfriends"
          hidden={fieldHidden(person, 'boyfriends')}
          onToggleHidden={(checked) => updateHiddenField('relationships', 'boyfriends', checked)}
          options={boyfriendsOptions}
          valueArr={boyfriendsArr}
          onChange={(val) => setRelMulti('boyfriends', val)}
          onSearch={setBoyfriendsSearch}
          onPhotoChange={(name, val) => setRelMultiPhoto('boyfriends', name, val)}
        />
        <MultiRelationshipField
          label="Husbands"
          field="husbands"
          hidden={fieldHidden(person, 'husbands')}
          onToggleHidden={(checked) => updateHiddenField('relationships', 'husbands', checked)}
          options={husbandsOptions}
          valueArr={husbandsArr}
          onChange={(val) => setRelMulti('husbands', val)}
          onSearch={setHusbandsSearch}
          onPhotoChange={(name, val) => setRelMultiPhoto('husbands', name, val)}
        />
        <MultiRelationshipField
          label="Wives"
          field="wives"
          hidden={fieldHidden(person, 'wives')}
          onToggleHidden={(checked) => updateHiddenField('relationships', 'wives', checked)}
          options={wivesOptions}
          valueArr={wivesArr}
          onChange={(val) => setRelMulti('wives', val)}
          onSearch={setWivesSearch}
          onPhotoChange={(name, val) => setRelMultiPhoto('wives', name, val)}
        />

        <MultiRelationshipField
          label="Step fathers"
          field="stepFathers"
          hidden={fieldHidden(person, 'stepFathers')}
          onToggleHidden={(checked) => updateHiddenField('relationships', 'stepFathers', checked)}
          options={stepFathersOptions}
          valueArr={stepFathersArr}
          onChange={(val) => setRelMulti('stepFathers', val)}
          onSearch={setStepFathersSearch}
          onPhotoChange={(name, val) => setRelMultiPhoto('stepFathers', name, val)}
        />
        <MultiRelationshipField
          label="Step mothers"
          field="stepMothers"
          hidden={fieldHidden(person, 'stepMothers')}
          onToggleHidden={(checked) => updateHiddenField('relationships', 'stepMothers', checked)}
          options={stepMothersOptions}
          valueArr={stepMothersArr}
          onChange={(val) => setRelMulti('stepMothers', val)}
          onSearch={setStepMothersSearch}
          onPhotoChange={(name, val) => setRelMultiPhoto('stepMothers', name, val)}
        />
        <MultiRelationshipField
          label="Foster parents"
          field="fosterParents"
          hidden={fieldHidden(person, 'fosterParents')}
          onToggleHidden={(checked) => updateHiddenField('relationships', 'fosterParents', checked)}
          options={fosterParentsOptions}
          valueArr={fosterParentsArr}
          onChange={(val) => setRelMulti('fosterParents', val)}
          onSearch={setFosterParentsSearch}
          onPhotoChange={(name, val) => setRelMultiPhoto('fosterParents', name, val)}
        />
        <MultiRelationshipField
          label="Foster children"
          field="fosterChildren"
          hidden={fieldHidden(person, 'fosterChildren')}
          onToggleHidden={(checked) => updateHiddenField('relationships', 'fosterChildren', checked)}
          options={fosterChildrenOptions}
          valueArr={fosterChildrenArr}
          onChange={(val) => setRelMulti('fosterChildren', val)}
          onSearch={setFosterChildrenSearch}
          onPhotoChange={(name, val) => setRelMultiPhoto('fosterChildren', name, val)}
        />
        <MultiRelationshipField
          label="Adoptive parents"
          field="adoptiveParents"
          hidden={fieldHidden(person, 'adoptiveParents')}
          onToggleHidden={(checked) => updateHiddenField('relationships', 'adoptiveParents', checked)}
          options={adoptiveParentsOptions}
          valueArr={adoptiveParentsArr}
          onChange={(val) => setRelMulti('adoptiveParents', val)}
          onSearch={setAdoptiveParentsSearch}
          onPhotoChange={(name, val) => setRelMultiPhoto('adoptiveParents', name, val)}
        />
        <MultiRelationshipField
          label="Adopted children"
          field="adoptedChildren"
          hidden={fieldHidden(person, 'adoptedChildren')}
          onToggleHidden={(checked) => updateHiddenField('relationships', 'adoptedChildren', checked)}
          options={adoptedChildrenOptions}
          valueArr={adoptedChildrenArr}
          onChange={(val) => setRelMulti('adoptedChildren', val)}
          onSearch={setAdoptedChildrenSearch}
          onPhotoChange={(name, val) => setRelMultiPhoto('adoptedChildren', name, val)}
        />
